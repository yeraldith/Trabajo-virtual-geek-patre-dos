...
function calculariva() {
    const iva = 0.21;
    var precio = parseInt(document.getElementById('txt').value);
    var precioConIva = (precio * iva) + precio;
    document.getElementById('text').innerHTML = precio;
    document.getElementById('text2').innerHTML = iva;
    document.getElementById('text3').innerHTML = precioConIva;
}